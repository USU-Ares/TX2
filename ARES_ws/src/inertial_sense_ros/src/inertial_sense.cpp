  ...
  nh_(), nh_private_("~"), initialized_(false)
{
 ...
 // nh_private_.param<std::string>("child_frame_id", child_frame_id_, "ins_link"); //Derek added this line
  child_frame_id_ = "ins_link";  //Derek is trying this instead of the above; reason being that the /ins (odom_msg) was not being published
  /// Connect to the uINS
...
void InertialSenseROS::INS1_callback(const ins_1_t * const msg)
{
  ...
  odom_msg.child_frame_id = child_frame_id_; //Derek added this line
